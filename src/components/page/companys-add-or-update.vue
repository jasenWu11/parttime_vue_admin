      ...
      <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
          ...
          <el-input v-model="dataForm.userName" disabled placeholder="用户名"></el-input>
				...
				<el-form-item label="企业名称" prop="cname">
				  <el-input v-model="dataForm.cname" disabled readonly placeholder="企业名称"></el-input>
				</el-form-item>
				
        <el-form-item label="官方网址" prop="chttp">
          <el-input v-model="dataForm.chttp" disabled placeholder="官方网址"></el-input>
        </el-form-item>
				<el-form-item label="企业地址" prop="address">
				  <el-input v-model="dataForm.address" disabled placeholder="企业地址"></el-input>
				</el-form-item>
        <el-form-item label="电话号码" prop="phone">
          <el-input v-model="dataForm.phone" disabled placeholder="电话号码"></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop="email">
          <el-input v-model="dataForm.email" placeholder="邮箱"></el-input>
        </el-form-item>
        <el-form-item label="成立时间" prop="ctime">
          <el-input v-model="dataForm.ctime" disabled placeholder="成立时间"></el-input>
        </el-form-item>
				<el-form-item label="企业规模" prop="scale">
				  <el-input v-model="dataForm.scale" placeholder="公司规模"></el-input>
				</el-form-item>
				<el-form-item label="企业简介" prop="introduce">
				  <el-input type="textarea" :rows="2" v-model="dataForm.introduce" placeholder="公司规模"></el-input>
				</el-form-item>
...
<script>
import { getInfo, update, resetPassword } from '@/api/companys'
// import { uploadeImg } from '@/api/common'
/* eslint-disable */
  export default {
    data () {
